...
- **_Speedsolving the Cube_ by Dan Harris** — the source of the algorithms and a foundational reference for anyone learning to solve the cube methodically.
- **[Speedsolving.com wiki](https://www.speedsolving.com/wiki/)** — the cubing community's collective knowledge base, including the OLL case numbering this app follows.
